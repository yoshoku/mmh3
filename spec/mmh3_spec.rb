...
RSpec.describe Mmh3 do
  ...
  describe '#hash128 (x86)' do
    it { expect(described_class.hash128('Hello, world', 0, false)).to eq(253056019824187517714158156925852552360) }
    it { expect(described_class.hash128('Hello, world', 7, false)).to eq(52510795136989075550025607058488316817) }
  end
end
